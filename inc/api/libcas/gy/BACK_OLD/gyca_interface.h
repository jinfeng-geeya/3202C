...
**	其他说明：  无
***********************************************************************************************/
extern GYS32	GYCA_Initialize(GYU8 camTaskPriority)CA_FUNCPOSTFIX;
...
**	返 回 值：	 无
**************************************************************************************************/
extern void GYCA_GetStbSn(GYU8 * sn/*MAX 20 BYTES*/, GYS16 *len)CA_FUNCPOSTFIX;
/***********************************************************************************************
...
**	其他说明：
**********************************************************************************************/
extern GYS32	GYCA_SC_DRV_Initialize(void)CA_FUNCPOSTFIX;
...
***********************************************************************************************/
extern GYS32 GYCA_SCStatus_RegisterEN2Notify(SC_Status_Notify_Fct_t SCStatusNotify)CA_FUNCPOSTFIX;
...
**	其他说明： 无
***********************************************************************************************/
extern GYBOOL GYCA_SC_ValidateATR(GYU8 *pbNewATR, GYU16 wLen)CA_FUNCPOSTFIX;
...
**	其他说明：
*********************************************************************************************/
extern  void GYCA_SC_DRV_ResetCard (GYU8 bCardNumber)CA_FUNCPOSTFIX;
...
***************************************************************************************************/
extern GYS32 GYCA_GetSMCIssueInfo(GYU8* pbIssueDate,GYU8* pbExpireDate)CA_FUNCPOSTFIX;
...
***************************************************************************************************/
extern GYS32 GYCA_GetSMCIssueInfoEx(GYU8* pbIssueDate,GYU8* pbExpireDate)CA_FUNCPOSTFIX;
/*************************************************************************************************
** 	函数名称:GYCA_GetSMCID
**************************************************************************************************
**	提 供 者：	 CA模块。
...
**	其他说明：	 卡ID为8个字节的BCD码。
**************************************************************************************************/
extern GYS32 GYCA_GetSMCID(GYU8* pbCardID )CA_FUNCPOSTFIX;
...
**	其他说明：
**************************************************************************************************/
extern GYS32 GYCA_GetSMCTokenInfo(void)CA_FUNCPOSTFIX;
...
**	其他说明：  无
**************************************************************************************************/
extern GYS32 GYCA_GetSMCUserLevel(void)CA_FUNCPOSTFIX;
...
**	其他说明：  无
**************************************************************************************************/
GYS32 GYCA_SetSMCUserLevel(GYU8 *pPin, GYU8 level)CA_FUNCPOSTFIX;
...
**	其他说明：
**************************************************************************************************/
extern GYS32 GYCA_GetSMCUserType(void)CA_FUNCPOSTFIX;
...
**	其他说明：
*************************************************************************************************/
extern GYS32 GYCA_GetSMCEntitleInfo(void)CA_FUNCPOSTFIX;
...
*************************************************************************************************/
extern GYS32 GYCA_GetBuffer (GYS32 *lStartAddr, GYS32* lSize)CA_FUNCPOSTFIX;
...
**	其他说明：
**************************************************************************************************/
extern GYS32 GYCA_ReadBuffer(const GYS32 lStartAddr, GYU8* pData, GYS32* nLen)CA_FUNCPOSTFIX;
...
**	其他说明：
*************************************************************************************************/
extern GYS32 GYCA_WriteBuffer(const GYS32 lStartAddr, const GYU8* pData, GYS32 nLen)CA_FUNCPOSTFIX;
...
**     其他说明：        无
***********************************************************************************************/
extern void   GYCA_GetVersionInfo(GYU8** ppVerInfo)CA_FUNCPOSTFIX;
...
**	其他说明：
**********************************************************************************************/
extern GYBOOL GYCA_IsMatchCAID(GYU16 wCASystemID)CA_FUNCPOSTFIX;
...
**	其他说明：        None
***********************************************************************************************/
extern void GYCA_SetEcmPID (GYU8 bType, T_CAServiceInfo* pEcmInfo)CA_FUNCPOSTFIX;
...
**	其他说明：
**********************************************************************************************/
extern void GYCA_SetEmmPID(GYU8 bType, const GYU16 wEmmPid)CA_FUNCPOSTFIX;
...
**	其他说明：
*************************************************************************************************/
extern GYS32 GYCA_GetOperatorInfo(T_CA_OperatorInfo *tInfo)CA_FUNCPOSTFIX;
...
**	其他说明：
*************************************************************************************************/
extern GYS32 GYCA_SetPaired(GYU8 *pbPin)CA_FUNCPOSTFIX;
...
**	其他说明：
****************************************************************************************************/
extern  GYS32 GYCA_GetPaired (void)CA_FUNCPOSTFIX;
...
**	其他说明：
*************************************************************************************************/
extern GYS32 GYCA_ChangePin(GYU8 *pbOldPin,GYU8 *pbNewPin)CA_FUNCPOSTFIX;
...
**					bParentLevel, 为用户想设置的家长控制级别。其取值范围只能设置0, 1, 2
**	输出参数： 无。
...
**	其他说明：
*************************************************************************************************/
extern GYS32 GYCA_SetParentControl(GYU8 *pbPin, GYU8 bParentLevel)CA_FUNCPOSTFIX;
...
**	其他说明：
*************************************************************************************************/
extern GYS32 GYCA_GetParentControl(GYU8 *pbParentLevel)CA_FUNCPOSTFIX;
...
**                                      
**********************************************************************************************/
extern GYS32 GYCA_RegisterAvaegisAPPEventCallback(GYS32 (*AvaegisAPPEventCallbackFunc)(GYU32,GYU32,GYU32,GYU32))CA_FUNCPOSTFIX;
...
**     其他说明：         无
***********************************************************************************************/
extern GYU32 GYCA_GetRandomNumber(GYU32 limit)CA_FUNCPOSTFIX;
...
** 其他说明：    无。
**********************************************************************************************/
extern GYS32 GYCA_IPPVGetBurseInfo (GYU16 wSp_ID,GYU8 byBurseID,T_CA_IPPVBurseInfo** pBurseInfo )CA_FUNCPOSTFIX;
...
**     其他说明：     无。
***********************************************************************************************/
extern GYS32 GYCA_IPPVStopBuyDlg(GYBOOL bIsBuy,GYU16 wEcmPid,GYU8 *pPin, T_CA_IPPVPrice *price)CA_FUNCPOSTFIX;
...
**     其他说明：     无
***********************************************************************************************/
extern void GYCA_HideIppvDlg(T_CAServiceInfo* pEcmInfo)CA_FUNCPOSTFIX;
...
**     其他说明： 无
***********************************************************************************************/
extern GYU32 GYCA_DBG_Print (const char *fmt, ...)CA_FUNCPOSTFIX;
...
**	其他说明：
*************************************************************************************************/
extern GYS32 GYCA_SetLicenseData (GYU8 *datap,  GYS32 dataLen)CA_FUNCPOSTFIX;
...
**	其他说明：
*************************************************************************************************/
extern GYS32 GYCA_GetLicenseData (GYU8 *datap,  GYU32 *dataLen)CA_FUNCPOSTFIX;
...
**********************************************************************************************/
extern GYS32 GYCA_IPPTGetBoughtRecord (GYU16 *wRecordCount, T_CA_IPPTBoughtRecord** pBoughtRcd)CA_FUNCPOSTFIX;
...
***********************************************************************************/
extern GYS32 GYCA_RegisterNetworkInfo(GYU32 networkID,GYU32 tsID,GYU32 originalNetworkID)CA_FUNCPOSTFIX;
...
**     其他说明：
***********************************************************************************/
extern GYS32 GYCA_GetMJDTime(GYU8 *mjd)CA_FUNCPOSTFIX;
...
**     其他说明：
***********************************************************************************/
extern GYS32 GYCA_GetCornerAdvertise(GYU16 wServiceID, T_CA_CornerAdvertise *pCornerAdvertise)CA_FUNCPOSTFIX;
...
**     其他说明：
***********************************************************************************/
extern GYBOOL GYCA_IsSonCard(void)CA_FUNCPOSTFIX; 
...
**     其他说明：
***********************************************************************************/
extern GYU8	GYCA_GetCardArea(void)CA_FUNCPOSTFIX; 
