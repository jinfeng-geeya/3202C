...
void putseqhdr()
{
  ...
  putbits(luma_width,12); /* horizontal_size_value */
  putbits(luma_height,12); /* vertical_size_value */
  ...
  putbits((int)(bit_rate/400),18); /* bit_rate_value */  
...
void putseqext()
{
  ...
  putbits((mpeg_profile<<4)|mpeg_level,8); /* profile_and_level_indication */
  putbits(prog_seq,1); /* progressive sequence */
  putbits(chroma_format,2); /* chroma_format */
  putbits(luma_width>>12,2); /* horizontal_size_extension */
  putbits(luma_height>>12,2); /* vertical_size_extension */
  //putbits(((int)ceil(bit_rate/400.0))>>18,12); /* bit_rate_extension */
  putbits(((int)(bit_rate/400))>>18,12); /* bit_rate_extension */
  putbits(1,1); /* marker_bit */
